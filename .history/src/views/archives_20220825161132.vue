                ...
                <div class="md-layout-item">
                  <md-field>
                    ...
                    <md-select
                      ...
                      @md-selected="filterRerender"
                      name="timeFilter.years"
                      id="timeFilter.years"
                    >
                      <md-option
                ...
                <div class="md-layout-item">
                  <md-field>
                    ...
                    <md-select
                      ...
                      @md-selected="filterRerender"
                      name="timeFilter.months"
                      id="timeFilter.months"
                    >
                      <md-option
...
export default {
  ...
  methods: {
    ...
    filterRerender() {
      var year = this.timeFilter.years;
      var month = this.timeFilter.months;
      var day = this.timeFilter.days;
      var filterBlocks = [];
