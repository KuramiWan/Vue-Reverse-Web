              ...
              <div class="md-layout md-gutter">
                <div class="md-layout-item">
                  <md-field>
                    ...
                    <md-select v-model="timeFilter.years" @change="filterRerender">
                      <md-option
                ...
                <div class="md-layout-item">
                  <md-field>
                    ...
                    <md-select v-model="timeFilter.months" @change="filterRerender">
                      <md-option
                ...
                <div class="md-layout-item">
                  <md-field>
                    ...
                    <md-select v-model="timeFilter.days" @change="filterRerender">
                      <md-option
...
export default {
  ...
  methods: {
    ...
    filter() {
      ...
      this.timeBlocks.forEach(block => {
        year.push(block.createTime.getFullYear());
        month.push(block.createTime.getMonth());
        day.push(block.createTime.getDay());
      });
  ...
  computed: {
    ...
    pageCountComputed() {
      return Math.ceil((this.timeBlocks.length + 1) / this.pagination.perPage);
    }
  }
};
</script>
