                ...
                <timeline>
                  ...
                  >
                    <router-link :to="'/detail/' + paginatedBlock.id">
                      ...
                      >
                        <div>
                          <p>ID: {{ timeBlocks.id }}</p>
                          <h4>标题: {{ timeBlocks.title }}</h4>
                          <p>
                            <ins>状态: {{ timeBlocks.status }}</ins>
                          </p>
                          <p>
                            <small>问题: {{ timeBlocks.question }}</small>
                          </p>
                          <p>
                            <small>时间: {{ timeBlocks.createTime }}</small>
                          </p>
                        </div>
                      </timeline-item>
                    </router-link>
...
export default {
  ...
  methods: {
    getArchives() {
      axios
        .post("/archives", { pageNum: 2, pageSize: 5 })
        .then(response => {
