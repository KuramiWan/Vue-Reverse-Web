              ...
              >
                <div>
                  <md-tooltip md-delay="1000" md-direction="top">
                    <div>
                      <md-button class="md-icon-button md-primary button" @click="isEdit">
                        <md-icon>edit</md-icon>
                      </md-button>
                      <md-button class="md-icon-button md-primary button" @click="update">
...
export default {
  ...
  methods: {
    ...
    update(){
      notification.post("/admin/announcement/update",this.announcementDetail,{
        headers:{
          Auth
        }
      })
