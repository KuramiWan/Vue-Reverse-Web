            ...
            <div v-if="select.show">
              ...
              >
                ...
                <md-table-row slot="md-table-row" slot-scope="{ item }">
                  <md-table-cell v-for="(label,index) in formStructure" :key="index" md-label="ID">
                    <md-field>
                      <label>{{label}}</label>
                      <md-input v-model="item.id"></md-input>
                    </md-field>
                  </md-table-cell>
                  <md-table-cell md-label="姓名"
                    ><md-field>
...
export default {
  ...
  data() {
    return {
      formStructure:[ID,姓名,标题,问题,状态,创建时间,解答,学院,预约时间,图片,是否归档,标签,电话],
