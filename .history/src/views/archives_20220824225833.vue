              ...
              <div class="md-layout md-gutter">
                <div class="md-layout-item">
                  <md-field>
                    ...
                    <md-select v-model="timeFilter.years" @change="reRender">
                      <md-option
                ...
                <div class="md-layout-item">
                  <md-field>
                    ...
                    <md-select v-model="timeFilter.months" @change="reRender">
                      <md-option
                ...
                <div class="md-layout-item">
                  <md-field>
                    ...
                    <md-select v-model="timeFilter.days" @change="reRender">
                      <md-option
