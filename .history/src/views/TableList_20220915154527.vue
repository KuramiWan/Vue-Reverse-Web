...
export default {
  ...
  methods: {
    confirm() {
      if (this.select.edit) {
        notification.post("/admin/user/update",headers:{
          Authorization:"eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJjcmVhdGUgdG9rZW4gd2hlbiBsb2dpbiIsInBlcm1pc3Npb25zIjoiMiIsImV4cCI6MTY2NTY2MjUzNCwidXNlcklkIjoxLCJpYXQiOjE2NjMwNzA1MzQsImp0aSI6IjVjZTQxYmJiLTJlMDgtNGU4YS1hNjI5LWI0OGY2YzFkZWE5MyJ9.7ksp28GaftQnQ8eIYE0FL41DTbu0VhuE8E0VQd6UL0Y"
        }).then();
        response => {
          this.getUser();
          return;
