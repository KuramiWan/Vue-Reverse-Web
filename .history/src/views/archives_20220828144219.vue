        ...
        <div class="container">
          ...
          <div class="mainAchieve">
            <div class="md-layout md-gutter md-alignment-center">
              <div
                class="md-layout-item md-large-size-25 md-medium-size-33 md-small-size-50 md-xsmall-size-100 sideBar"
              >
                <div class="color"></div>
              </div>
              <div
                class="md-layout-item md-large-size-75 md-medium-size-66 md-small-size-50 md-xsmall-size-100 mainBar"
              >
                <div class="color"></div>
              </div>
            </div>
