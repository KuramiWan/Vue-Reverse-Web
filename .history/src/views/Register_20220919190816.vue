          ...
          >
            <login-card header-color="green">
              ...
              <md-field class="md-form-group" slot="inputs">
                ...
                <label>密码...</label>
                <md-input v-model="passwordOne" type="password"></md-input>
              </md-field>
              <md-field class="md-form-group" slot="inputs">
                <md-icon>lock_outline</md-icon>
                <label>确认密码...</label>
                <md-input type="password" v-model="passwordTwo"></md-input>
                <p v-if="passwordInconsistent" class="line md-caption">
                  Helper text
                </p>
              </md-field>
              <!-- <md-field class="md-form-group" slot="inputs">
